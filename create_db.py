...
sql_statements = [
    ...
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (3,1, 'Pharmacy 3', 'New York', 0,41.335212, 36.253966);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (4,2, 'Pharmacy 4', 'Los Angeles', 0,41.326840, 36.269434);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (5,1, 'Pharmacy 5', 'New York', 1,41.334128, 36.270936);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (6,2, 'Pharmacy 6', 'Los Angeles', 0,41.334805, 36.249907);",
