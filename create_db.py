...
sql_statements = [
    ...
    "INSERT INTO station (station_name, station_latitude, station_longitude) VALUES ('Station E', 41.331953, 36.204621);",
    ...
    "INSERT INTO park (park_name, station_id, park_full) VALUES ('Park X', 7, 3);",
    "INSERT INTO park (park_name, station_id, park_full) VALUES ('Park Y', 8, 6);",
    '''INSERT INTO traffic (crowd_situation, station_id, station_ids) VALUES (0.5, 1,'["3","4"]')''',
    '''INSERT INTO traffic (crowd_situation, station_id, station_ids) VALUES (0.8, 6,'["5","6"]')''',
    ...
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (1,1, 'Pharmacy 1', 'New York', 1,41.344733, 36.248282);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (2,2, 'Pharmacy 2', 'Los Angeles', 0,41.336549, 36.233305);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (1,1, 'Pharmacy 1', 'New York', 1,41.335212, 36.253966);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (2,2, 'Pharmacy 2', 'Los Angeles', 0,41.326840, 36.269434);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (1,1, 'Pharmacy 1', 'New York', 1,41.334128, 36.270936);",
    "INSERT INTO pharmacy (pharmacy_id,work_time_id, pharmacy_name, pharmacy_location, pharmacy_on_duty,pharmacy_latitude,pharmacy_longitude) VALUES (2,2, 'Pharmacy 2', 'Los Angeles', 0,41.334805, 36.249907);",
