...
import 'package:bocekilaclama/core/constants/enums/preference_keys_enum.dart';
import 'package:bocekilaclama/core/init/secure_manager/secure_manager.dart';
...
class LocaleManager {
  ...
  Future<void> setCryptedData(PreferencesKeys key, dynamic value) async {
    ...
    await _preferences
        .setString(key.toString(), temp)
        .then((value) => debugPrint("saved crypted data -> $key"));
  }
